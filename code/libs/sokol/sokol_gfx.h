...
/*
    NOTE(murky): In order to allow for hot reloading, the global state is redefined as a pointer
    which is set in the game init function. Same goes for sokol_gp
