...
:: Build opts
set compiler=-nologo -std:c11 -W4 -WX -wd4244 -wd4042 -wd4267 -wd4456 -wd4127 -wd4116
...
set game_libs=-I%lib_dir%\Steamworks\sdk\redistributable_bin\win64\steam_api64.lib opengl32.lib
...
:: DLL linker opts
set dll_link=-EXPORT:GameInit -EXPORT:GameTick
...
cl -Od %compiler% -DOS_WINDOWS=1 %defines% %debug% %platform_includes% %code_dir%\platform_sdl.c %platform_libs% -Feplatform /link %link% %platform_link%
